...
def reconcile():
    db = SessionLocal()
    try:
        print("Starting Deep Reconciliation with Double Deduction Rule...")
        ...
        for r in resellers:
            ...
            # Total Purchased is in r.total_credits
            correct_available = float(r.total_credits) - total_distributed - own_usage - total_sub_usage
        ...
        db.commit()
        print("SUCCESS: Deep Reconciliation complete.")
